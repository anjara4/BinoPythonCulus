...
from view.ui_saccade_exercice import UI_saccade
from view.ui_fixation_exercice import UI_fixation
from view.ui_infinite_exercice import UI_infinite
from view.ui_spiral_exercice import UI_spiral

from view.ui_customDialog import CustomDialog

from view.pupil_labs import Pupil_labs
from model.cam_video import Camera
...
class UI_main_excercice(QWidget):
    def __init__(self, connected_patient, selected_config):
        ...
        self.sub_tab_spiral.toggleSignal.connect(self.toggle_is_mode_pupil_spiral)
        ...
        sub_tabs.addTab(self.sub_tab_spiral, "Spiral")
    ...
    def toggle_is_mode_pupil_spiral(self, enabled):
