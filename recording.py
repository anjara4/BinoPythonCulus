...
class CSV_recorder:
    ...
    def save_configuration(self, file_configuration, name_configuration, depth, screen_width, screen_height, width_target_infini_object_cm, date_creation):
        with open(file_configuration, 'a', newline='') as csvfile:
            writer = csv.writer(csvfile, delimiter=';')
            writer.writerow([name_configuration, depth, screen_width, screen_height, width_target_infini_object_cm, date_creation])
